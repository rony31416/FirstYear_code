...
public class tic_tac_toE {
	...
	private void winingGame()
	{
		...
		{
			JOptionPane.showMessageDialog(frame, "The Match is DRAW","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
			setval();
	...
	private void initialize() {
		...
		btn1.setFont(new Font("Ubuntu", Font.BOLD, 80));
		...
		btn2.setFont(new Font("Ubuntu", Font.BOLD, 80));
		panel_7.add(btn2, BorderLayout.CENTER);
		...
		btn3.setFont(new Font("Ubuntu", Font.BOLD, 80));
		...
		lblPlayerX.setFont(new Font("Dialog", Font.BOLD, 22));
		...
		xCount.setFont(new Font("Dialog", Font.BOLD, 40));
		...
		btn4.setFont(new Font("Ubuntu", Font.BOLD, 80));
		...
		btn5.setFont(new Font("Ubuntu", Font.BOLD, 80));
		...
		btn6.setFont(new Font("Ubuntu", Font.BOLD, 80));
		...
		lblPlayerO.setFont(new Font("Dialog", Font.BOLD, 22));
		lblPlayerO.setHorizontalAlignment(SwingConstants.CENTER);
		panel_8.add(lblPlayerO, BorderLayout.CENTER);
		...
		oCount.setText("0");
		oCount.setFont(new Font("Dialog", Font.BOLD, 40));
		...
		btn7.setFont(new Font("Ubuntu", Font.BOLD, 80));
		...
		btn8.setFont(new Font("Ubuntu", Font.BOLD, 80));
		...
		btn9.setFont(new Font("Ubuntu", Font.BOLD, 80));
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(JOptionPane.showConfirmDialog(frame, "Do you Exit?","Tic Tac Toe",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_NO_OPTION)
				{
				  System.exit(0);
				}			
			}
